...
const ParticipationLog: React.FC<{ onBack: () => void }> = ({ onBack }) => {
 ...
 <button onClick={() => handleCreateSession(false)} className="neumorphic-button bg-gray-50 text-white px-4 py-2 font-bold flex-1">إنشاء فارغ</button>
 ...
 <button onClick={() => setShowImportModal(false)} className="px-4 py-2 rounded bg-gray-50 text-white font-bold">إلغاء</button>
