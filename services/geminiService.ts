...
export const generateSmartLessonPlan = async (inputText: string, context: any) => {
    try {
        ...
        يجب أن يكون التحضير بتنسيق JSON دقيق يحتوي على المفاتيح التالية بدقة لملء الحقول تلقائياً:
        {
            ...
            "intro": { "text": "نص التمهيد (لا يتجاوز سطرين بأي حال من الأحوال)", "type": "نوع التمهيد (سؤال، قصة...)" },
            ...
            "content": "محتوى الدرس ملخصاً في 6 نقاط فقط (على شكل رؤوس أقلام مركزة وشاملة)",
        ...
        شروط صارمة:
        1. التمهيد يجب أن يكون قصيراً جداً (سطرين كحد أقصى).
        2. محتوى الدرس يجب أن يكون ملخصاً في 6 نقاط فقط (قائمة منقطة).
        3. تأكد أن الأهداف السلوكية تتنوع بين المعرفي والمهاري والوجداني.
        `;
